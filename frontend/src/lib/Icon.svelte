<script lang="ts">
  // Small line-icon set (feather-style, 24×24, stroke = currentColor) so the UI
  // uses real iconography instead of emoji. Colour follows the surrounding text.
  export let name: string;
  export let size = 16;
  export let stroke = 1.75;

  // Each entry is the inner markup of the <svg>.
